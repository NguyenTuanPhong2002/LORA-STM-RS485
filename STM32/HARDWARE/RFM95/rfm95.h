...
/**
 * @brief RFM95_HandleTypeDef handle structure definition
 *
 */
typedef struct
{
	LORA_HandleTypeDef parent;
	void *hspi;
	uint16_t resetPin;
	uint16_t nssPin;
	uint16_t dio0;
...
CTL_StatusTypedef RFM95_setCodingRate(RFM95_HandleTypeDef *const me, const uint8_t CR);
CTL_StatusTypedef RFM95_setBandwidth(RFM95_HandleTypeDef *const me, const uint8_t BW);
CTL_StatusTypedef RFM95_setCRCMode(RFM95_HandleTypeDef *const me, const uint8_t CRCMode);
...
CTL_StatusTypedef RFM95_setRFPowerAmplifier(RFM95_HandleTypeDef *const me, const uint8_t paSelect, uint8_t Pout);
...
CTL_StatusTypedef RFM95_setFrequency(RFM95_HandleTypeDef *const me, const uint32_t frequency);
CTL_StatusTypedef RFM95_transmit(RFM95_HandleTypeDef *const me, uint8_t *pData, uint8_t size, uint32_t timeout);
// CTL_StatusTypedef RFM95_receive(RFM95_HandleTypeDef * const me, uint8_t mode, uint8_t pBuffer[], uint8_t size, uint32_t timeout);
// CTL_StatusTypedef RFM95_receiveSingle(RFM95_HandleTypeDef * const me, uint8_t pBuffer[], uint8_t size, uint32_t timeout);
...
CTL_StatusTypedef RFM95_mappingDIO0(RFM95_HandleTypeDef *const me, const uint8_t mappingMode);
